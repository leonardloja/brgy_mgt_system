...
Public Class CrysRptIndigency
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "brgy_mgt_system.CrysRptIndigency.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysRptIndigency
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysRptIndigency = New CrysRptIndigency()
        rpt.Site = Me.Site
        Return rpt
    End Function

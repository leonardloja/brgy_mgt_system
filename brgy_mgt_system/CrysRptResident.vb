...
Public Class CrysRptResident
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "brgy_mgt_system.CrysRptResident.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysRptResident
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysRptResident = New CrysRptResident()
        rpt.Site = Me.Site
        Return rpt
    End Function

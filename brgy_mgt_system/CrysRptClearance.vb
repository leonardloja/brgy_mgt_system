...
Public Class CrysRptClearance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "brgy_mgt_system.CrysRptClearance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysRptClearance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysRptClearance = New CrysRptClearance()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CrysRptResidency
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "brgy_mgt_system.CrysRptResidency.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysRptResidency
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysRptResidency = New CrysRptResidency()
        rpt.Site = Me.Site
        Return rpt
    End Function
